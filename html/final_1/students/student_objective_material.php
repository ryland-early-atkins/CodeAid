...
<body>
<!--top of page buttons-->
<form style="float:left;" action='student_welcome_1.php'><input type="submit" value="back"></form>
<form style="float:right;" action="../end_codeaid/logout.php"><input type="submit" value="logout"></form>
<form style="text-align:left;" action="student_home.php"><input type="submit" value="home"></form>
...
<?php
if(isset($_POST['edit']) && $_POST['edit']){
	echo '<form style="text-align:left;float:left;" action="student_objective_material.php" method="post">';
	echo '<input type="hidden" name="objective_id" value='.$objectiveid.'>';
